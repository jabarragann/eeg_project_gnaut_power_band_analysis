...
def main():
    window_size = 15
    root_path = Path(r'C:\Users\asus\OneDrive - purdue.edu\RealtimeProject\Realtime-Project-Purdue-experiments\txt')
    dst_path = Path(r'C:\Users\asus\OneDrive - purdue.edu\RealtimeProject\Realtime-Project-Purdue-experiments\fusefeatures')

    labels = ['NeedlePassing', 'BloodNeedle']
    for p in root_path.glob("*/S01"):
        eye_tracker_path = root_path.parent / 'eyetracker' / p.parent.name / 'S01'
        eeg_path = p
        print("Extracting data from: ")
        print(eye_tracker_path, eye_tracker_path.exists())
        print(eeg_path, eeg_path.exists())
